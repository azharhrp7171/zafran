                ...
                <div class="content">
                    ...
                    <section>
                        <nav class="scroll-nav scroll-init">
                            <ul>
                                <li><a class="scroll-link act-scrlink" href="#menu-section-1"><span>Zafran Special BBQ</span></a></li>
                            ...
                            <div class="menu-wrapper single-menu fl-wrap" id="menu-section-1" data-scrollax-parent="true">
                                <div class="menu-wrapper-title fl-wrap">
                                    <div class="menu-wrapper-title-item">
                                        <h4>Zafran Special BBQ</h4>
                                        <h5>Pellentesque eros mi, faucibus tempor scelerisque nec, efficitur nec nunc.</h5>
                                    </div>
                                    <div class="bg par-elem "  data-bg="images/bg/1.jpg" data-scrollax="properties: { translateY: '40%' }"></div>
                                    <div class="overlay"></div>
                                ...
                                <div class="hero-menu-item">
                                    ...
                                    <div class="hero-menu-item-title fl-wrap">
                                        <h6>   Whole Chiken Tandori</h6>
                                        <div class="hmi-dec"></div>
                                        <span class="hero-menu-item-price">$20.99</span>
                                        <div class="add_cart">Add To Cart</div>
                                    </div>
                                    <div class="hero-menu-item-details">
                                        <p> Full Chargha Lahori Style.</p>
                                    </div>
                                </div>
                                <!-- hero-menu-item end-->  
                                <!-- hero-menu-item-->
