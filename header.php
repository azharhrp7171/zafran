                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <!--second level -->
                                            <ul>
                            <li><a href="menu.html">Zafran Special BBQ</a></li>
                            <li><a href="menu2.html">Appetizers</a></li>
                            <li><a href="menu3.html">Peshwar Namak Mandi/Clay Oven</a></li>
                            <li><a href="menu3.html">Main Course</a></li>
                            <li><a href="menu3.html">Rice Dishes/Dam Biryani</a></li>
                            <li><a href="menu3.html">Vegeterian</a></li>
                                            </ul>
                                            <!--second level end-->
                                        </li>
