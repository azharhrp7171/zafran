        ...
        <div id="main">
            <header class="main-header">
                ...
                <div class="header-top">
                    <div class="container">
                        ...
                        <div class="header-top_contacts"><a href="#"><span>Call now:</span> 980-258-0651</a><a href="#"><span>Write :</span> info@zafran.com</a></div>
                    </div>
                </div>
                <!--header-top end -->
                <!-- header-inner -->
                            ...
                            <div class="nav-holder main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                         <a href="#">Catering<i class="fas fa-caret-down"></i></a>
                                         <ul>
                                                
                                                <li><a href="https://www.ezcater.com/brand/pvt/zafran-kabab-palace" target="_blank">Order Catering</a></li>
                                            </ul>
                                        </li>
            ...
            <div id="wrapper">
                ...
                <div class="hero-wrap fl-wrap full-height" data-scrollax-parent="true">
                    <div class="bg par-elem "  data-bg="https://wallpapercave.com/wp/wp7353548.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    <div class="overlay"></div>
                    <div class="hero-title-wrap fl-wrap">
                        <div class="container">
                            <div class="hero-title">
                                <h4>Top Services and Premium Cuisine </h4>
                                <h2>Welcome to Zafran Kabab Palace</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="section-title text-align_left">
                                        <h2>WELCOME TO ZAFRAN KABAB PALACE</h2>
                                        <h4>BBQ’S/TANDOORI(CLAY OVEN)</h4>
                                        <div class="dots-separator fl-wrap"><span></span></div>
                                    </div>
                                    <div class="text-block ">
                                        <p>All BBQ are influence from namak Mandi Peshawar Pakistani food market with the recipe of Pakistani, Afghani & Persian.
                                        </p>
                        ...
                        <div class="column-section-wrap dark-bg" >
                            <div class="container"  >
                                <div class="column-text">
                                    ...
                                    <div class="big-number"><a href="#">980-258-0651</a></div>
                                </div>
                            </div>
